      ...
      <div class="content-wrapper" >
        ...
        <section class="content">
          ...
          <div class="form-group">
            <button class="btn btn-danger btn-sm menu-baru-btn">Menu Baru</button>
          </div>

          <div class="box box-danger menu-baru-box">
            <div class="box-body">
              ...
              <div class="form-group">
                <button class="btn btn-xs btn-danger buat-menu-btn">Buat Menu</button>
              </div>
