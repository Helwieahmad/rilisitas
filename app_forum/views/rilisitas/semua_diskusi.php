              ...
              <div class="row">
                  ...
                  <div class="col-md-9">
                  	<div class="row">	
                    	...
                    	<?php foreach ($semua_diskusi as $key => $diskusi) {
                  echo"<div class='box box-solid' style='padding:15px'>";
	              echo"<div class='box-body'>";
					echo"<div class='row'>";
						echo"<div class='col-md-5'>";
							echo "<img  class='img-responsive' src='".img_diskusi_url($diskusi['foto'])."' alt='$diskusi[judul]' />";
						echo"</div>";

						echo"<div class='col-md-7'>";
							echo "<a href='".diskusi_url($diskusi['id'],$diskusi['slug'])."'><h2 class='judul no-margin text-red'>$diskusi[judul]</h2></a><br>";
							echo "<div class='info'>";
							echo "<span class='tanggal'> <i class='fa fa-calendar'></i>&nbsp; ".format_tanggal($diskusi['tanggal'])."</span> 
								  <span class='author'> <i class='fa fa-user'></i>&nbsp; $diskusi[nama_admin]</span> 
								  <span class='dibaca'> <i class='fa fa-eye'></i>&nbsp; Dibaca $diskusi[dibaca] kali </span>";
							...
							echo "</div><br>";
							echo strip_tags(word_limiter($diskusi['isi'],45));
						echo"</div>";
					echo"</div>";
