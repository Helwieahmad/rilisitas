...
<html>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?php echo base_url() ?>" target='_top'><span style="color:#a80000">RILISITAS</span></a>
      </div><!-- /.login-logo -->
 ...
 <span class='glyphicon glyphicon-alert'></span> Username atau password salah!
        ...
        ?>
        <form action="<?php echo base_url() ?>author/proseslogin" method="POST">
          ...
          <div class="row">
              ...
              <div class="col-xs-8">
                <span class='pull-right' ><a class="btn btn-info-flat text-red" href="<?php echo base_url()?>author/register">Daftar Sebagai Riliser</a></span>
              </div>
            </div>
          </div>
