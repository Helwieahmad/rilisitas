        ...
        //  $.material.init();
         ...
         cek_koneksi(); 
          ...
          var foto_pop_up=new Dropzone(".area-pop-up-upload",{
            url:"<?php echo base_url() ?>AN_ajax_author/upload_pop_up",
            maxFilesize:2,
            maxFiles:1,
            method:"post",
            acceptedFiles:"image/*",
 ...
 ?>
        ...
        window.myPie = new Chart(ctx).Pie(pieData);
          ...
          $(".tom-tambah").click(function(){
            ...
            if(reg.test(nil_kat)){
              $.ajax({
                type:"POST",
                url:'<?php echo base_url() ?>AN_ajax_author/new_kategori',
          ...
          $(document).on("click",".tom-tambah-sub",function(){
            ...
            show_proses("Menambahkan Sub-Kategori");
              $.ajax({
                  type:"POST",
                  url:'<?php echo base_url() ?>AN_ajax_author/new_kategori/'+id_n,
       ...
       function hapus_kat(t){
             if(!ajax_request){
                ...
                $.ajax({
                      type:"POST",
                      url:'<?php echo base_url() ?>AN_ajax_author/hapus_kategori',
                      data:{id:k_id},
                      cache:false,
                      success: function(a){
                        if(a=='ok'){
          ...
          <!--Menonaktifkan Kategori-->
            function nonaktif_kategori(t){
              if(!ajax_request){
                ...
                $.ajax({
                  type:"POST",
                  url:'<?php echo base_url() ?>AN_ajax_author/nonaktifkan_kategori',
                  data:{id:id_no},
                  cache:false,
                  success:function(a){
                    if(a=='ok'){
          ...
          $(document).on("click",".akt_kategori",function(){
            if(!ajax_request){
              ...
              $.ajax({
                type:"POST",
                url:'<?php echo base_url() ?>AN_ajax_author/aktifkan_kategori',
                data:{id_a:a_id},
                cache:false,
                success:function(a){
                  if(a=="ok"){
        ...
        $(document).on("submit","div.cari form",function(e){
          ...
          if(regg.test(vall)){
            $.ajax({
              type:"POST",
              url:'<?php echo base_url() ?>AN_ajax_author/ubah_kategori',
        ...
        $(".form-user-baru input#username").blur(function(){
          ...
          if(userval!=''){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/cek_new_username",
      ...
      setInterval(cek_no_error,500);
          ...
          /* Untuk upload avatar admin */
           ...
           var AvatarBaru=new Dropzone(".avatar_user", { url: "<?php echo base_url() ?>AN_ajax_author/avatar_new" ,
                                                      maxFilesize: 2,
                                                      maxFiles: 1,
                                                      method:'post',
                                                      acceptedFiles:"image/*",
           ...
           AvatarBaru.on("removedfile",function(a){
            if(a.status=='success'){
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>AN_ajax_author/delete_foto_temp",
            ...
            function proses_new_admin(_this){
              ...
              var username=_this.find("input#username").val(),
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url() ?>AN_ajax_author/new_admin",
                  ...
                  success:function(a){
                   ...
                   show_proses("Berhasil!, mengalihkan halaman...")
                    window.location="<?php echo base_url() ?>author/all_user";
          ...
          <?php  if($npage=="5"){ ?>
            ...
            $(document).on("submit","table#daftar-user form.username",function(e){
              ...
              if(!ajax_request){
                ...
                if(/^[\w]{3,100}$/.test(valu)){
                  ...
                  $.ajax({
                    type:"POST",
                    url:"<?php echo base_url() ?>AN_ajax_author/edit_username",
            ...
            $(document).on("submit","table#daftar-user form.full_name",function(e){
              ...
              if(!ajax_request){
                ...
                if(/^\w[\w\s]+$/.test(valu)){
                  ...
                  $.ajax({
                    type:"POST",
                    url:"<?php echo base_url() ?>AN_ajax_author/edit_fullname",
            ...
            $(document).on("submit","table#daftar-user form.email",function(e){
              ...
              if(!ajax_request){
                ...
                if(/^[\w-.]+@[0-9a-zA-Z_.]+\.[0-9a-zA-Z_.]+$/.test(valmail)){
                  ...
                  $.ajax({
                    type:"POST",
                    url:"<?php echo base_url() ?>AN_ajax_author/edit_email",
             ...
             $(document).on("change","table#daftar-user select.level",function(e){
              if(!ajax_request){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url() ?>AN_ajax_author/edit_level",
                  data:{"id":id,"level":level},
                  cache:false,
                  success:function(a){
                    if(a=="ok"){
                      var show=(level=="0")?"author":"Super Admin";
            ...
            $(document).on("change","table#daftar-user select.status",function(e){
              if(!ajax_request){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url() ?>AN_ajax_author/edit_status",
              ...
              $(document).on("click","#modal-password button.save",function(){
                if(!ajax_request){
                  ...
                  $("#modal-password input#editrepassword").focus();
                    ...
                    $.ajax({
                      type:"POST",
                      url:"<?php echo base_url() ?>AN_ajax_author/edit_password",
            ...
            var main_foto=false;
           var foto_box= new Dropzone("#modal-foto .area-foto",{ url: "<?php echo base_url() ?>AN_ajax_author/avatar_update" ,
                                                      maxFilesize: 2,
                                                      maxFiles: 1,
                                                      method:'post',
                                                      acceptedFiles:"image/*",
           ...
           foto_box.on("complete",function(a){
            ...
            $(document).on("click","#modal-foto button.ok",function(){
             ...
             $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/ganti_user_avatar",
              data:{id:__id},
              cache:false,
             ...
             function hapus_user(_this){
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>AN_ajax_author/delete_user",
                data:{"id":id_r},
                cache:false,
                success:function(a){
                  if(a=="ok"){
...
?>
  ...
  $(".area_count").html(tag_terpilih.length);
          ...
          var j_foto_yaang_diupload=0;
           ...
           var foto_artikel=new Dropzone(".foto_gallery_artikel", { url:"<?php echo base_url() ?>AN_ajax_author/foto_gallery_artikel" ,
                                                      maxFilesize: 2,
                                                      method:'post',
                                                      acceptedFiles:"image/*",
                                                      paramName:"userfile",
           ...
           foto_artikel.on("removedfile",function(a){
            ...
            $.ajax({
              type:"POST",
              data:{"token":tok},
              url:"<?php echo base_url() ?>AN_ajax_author/delete_foto_artikel_temp",
              cache:false,
              success:function(a){
          ...
          foto_artikel.on("success",function(a,b){
           ...
           var html="<div class='aPhotoThumb col-md-4 col-xs-4'><span class='label label-danger hapus_label'> menghapus... </span>  <button class='btn btn-danger btn-sm featured-tombol'>jadikan featured image</button><span class='glyphicon glyphicon-remove hapus_foto_artikel' id='"+data_n.id+"'></span><div class='hover_foto_artikel' ></div><img src='<?php echo base_url() ?>an-component/media/upload-gambar-artikel-thumbs/"+data_n.gambar+"'></div>";
        ...
        foto_artikel.on("success",function(a,b){
           ...
           $(".save-artikel").click(function(){
            ...
            var ada_foto=((<?php echo $artikel_id ?>==0 && j_foto_yaang_diupload>0) || (<?php echo $artikel_id ?>>0 && $(".aPhotoThumb").length >0 ));
              ...
              var alamat_a=(id_aa==0)?"<?php echo base_url() ?>AN_ajax_author/submit_artikel/0":"<?php echo base_url() ?>AN_ajax_author/submit_artikel/3"
              if(judul_k==""){
                $("#judul_artikel").focus();
                ...
                $.ajax({
                  ...
                  success: function(a){
                    if(a=='publish'){
                      ...
                      window.location.assign("<?php echo base_url() ?>author/artikel/"+a);
                      } else {
           ...
           $(document).on("save-draft",function(){
            if(!lagiSimpanDraft){
              ...
              var __Ddata={
                ...
                $.ajax({
                  type:"POST",
                  url:(Did_a==0)?"<?php echo base_url() ?>AN_ajax_author/submit_artikel/0":"<?php echo base_url() ?>AN_ajax_author/submit_artikel/3",
                  data: __Ddata,
                  cache: false,
                  success: function(a){
          ...
          function hapusMultiPhoto(_this){
            ...
            $.ajax({
              type: "POST",
              url: "<?php echo base_url() ?>AN_ajax_author/delete_multi_photos",
              data: {"id":_dataHapus},
              cache: false,
              success: function(a){
          ...
          $(document).on("click",".featured-tombol",function(){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/set_featured_image",
          ...
          $(document).on("mouseenter mouseleave",".aPhotoThumb",function(e){
           ...
           function hapusFoto(_this){
            ...
            $.ajax({
              type: "POST",
              url:"<?php echo base_url() ?>AN_ajax_author/delete_atikel_foto",
              data:{"id": _4id},
              cache:false,
              success: function(a){
                if(a=='deleted'){
            ...
            ?>
             ...
             function hapus_artikel(_this){
              ...
              ajax_request=true;
               ...
               $.ajax({
                type: 'post',
                url:"<?php echo base_url() ?>AN_ajax_author/delete_artikel",
                data: {'id':id},
                cache: false,
                success: function(a){
                  if(a=='ok'){
            ...
            ajax_request=true;          
              ...
              if(!/^\w[a-zA-Z0-9 -]{2,20}$/.test(_tag)){
                ...
                var _data={"tag":_tag,"slug":__slug};
                  ...
                  $.ajax({
                    type: "POST",
                    url:"<?php echo base_url() ?>AN_ajax_author/new_tag",
                    data:_data,
                    cache:false,
                    success:function(a){
                      if(a=="ok"){
        ...
        var _dataObj={};
            ...
            $(document).on("submit",".slug-table form",function(e){
              ...
              function eksekusi(__val){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo base_url() ?>AN_ajax_author/edit_tag",
                  data:_dataObj,
                  cache:false,
                  success: function(a){
                    if(a=="ok"){
            ...
            function hapus_tag(id){
              ...
              $.ajax({
                type:"POST",
                data:{"id":id},
                url:"<?php echo base_url() ?>AN_ajax_author/hapus_tag",
                cache:false,
                success:function(a){
                  if(a=="ok"){                    
                        show_proses("Berhasil! Mereload halaman");
           ...
           ?>
            ...
            function hapusMedia(_this){
              ...
              $.ajax({
                type:'POST',
                url:'<?php echo base_url() ?>AN_ajax_author/delete_media',
                data:{'id':mediaId},
                cache:false,
                success: function(a){
                  if(a=='ok'){
            ...
            function hapusPendukung(_this){
              ...
              $.ajax({
                type:'POST',
                url:'<?php echo base_url() ?>AN_ajax_author/delete_media_pendukung',
                data:{'nama':mediaName},
                cache:false,
                success: function(a){
                  if(a=='ok'){
          ...
          var upload_media_pendukung=new Dropzone(".multiple-area",{
            url:"<?php echo base_url() ?>AN_ajax_author/upload_multiple_pendukung",
            maxFilesize:2,
            method:"post",
            acceptedFiles:"image/*",
            paramName:"userfile",
          ...
          upload_media_pendukung.on("queuecomplete",function(){
           ...
           ?>
            ...
            $(document).on("click","#simpan-infromasi",function(){
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>AN_ajax_author/simpaninformasi",
                data:data,
                cache:false,
                success:function(a){
                  if(a=="ok"){
          ...
          $(document).on("click",".update-biodata",function(){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/simpanbiodata",
          ...
          <?php
           ...
           ?>           
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/page",
              ...
              success:function(a){
                if(a=="ok"){
                  ...
                  if(/^[\d]+$/.test(a)){
                    window.location.assign("<?php echo base_url(); ?>author/page/"+a);
           ...
           function delete_page(_this){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/delete_page",
              data:{"id":id_page},
              cache:false,
              success:function(a){
                if(a=="ok"){
        ...
        var foto_galeri=new Dropzone(".foto_galeri", { url:"<?php echo base_url() ?>AN_ajax_author/foto_galeri" ,
                                                      maxFilesize: 2,
                                                      method:'post',
                                                      acceptedFiles:"image/*",
                                                      paramName:"userfile",
            ...
            function proses_simpan(_this){
              ...
              $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>AN_ajax_author/save_galeri",
                ...
                success: function(a){
                  if(a=="ok"){                    
                    ...
                    if(/^[\d]+$/.test(a)){
                    window.location.assign("<?php echo base_url() ?>author/galeri/"+a);
                  //  ajax_request=false;
                    } else {
           ...
           foto_galeri.on("removedfile",function(a){
            ...
            $.ajax({
              type:"POST",
              data:{"token":tok},
              url:"<?php echo base_url() ?>AN_ajax_author/delete_foto_galeri_temp",
              cache:false,
              success:function(a){
                console.log("delete sukses");
              },
           ...
           $(document).on("click",".btn-simpan-desk",function(){
            ...
            $("[id='floatingBarsG'][class='"+id1+"']").show();
             $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/edit_deskripsi_galeri",
        ...
        $(".galeri_area").prepend(elem).isotope("prepended",elem);
          ...
          function delete_galeri_foto(_this){
           ...
           // alert(id);
            $.ajax({
              type:"POST",              
              url:"<?php echo base_url() ?>AN_ajax_author/delete_foto_galeri",
              data:{"id":id_foto_gal},
              cache: false,
              success:function(a){
                if(a=="ok"){
          ...
          <?php
           ...
           function hapus_galeri(_this){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url() ?>AN_ajax_author/delete_galeri",
              data:{"id":id_galeri},
              cache: false,
              success:function(a){
                if(a=="ok"){                  
         ...
         <?php
           ...
           //   add_to_list(0,{id:100,nama:"test",code:"testCode",url:"http://test.com","target":"_blank"});
             ...
             $.ajax({
                type:"POST",
                url:"<?php echo base_url() ?>AN_ajax_author/insert_new_menu",
          ...
          $.ajax({
            type:"POST",
            url:"<?php echo base_url() ?>AN_ajax_author/insert_new_sub_menu",
            data:{
      ...
      $(document).on("click",'.update-menu',function(){
       ...
       // show_proses("Mengupdate Menu");
        ...
        $.ajax({
          type:"POST",
          url:"<?php echo base_url() ?>AN_ajax_author/update_menu",
      ...
      function hapus_menu(_this){
          ...
          $.ajax({
            type:"POST",
            url:"<?php echo base_url('AN_ajax_author/delete_menu_child'); ?>",
      ...
      $(".update-posisi").click(function(){
        ...
        $.ajax({
          type:"POST",
          url:"<?php echo base_url() ?>AN_ajax_author/atur_menu",
        ...
        console.log(arr);
          ...
          <?php
           ...
           function proses_hapus_menu(_this){
            ...
            $.ajax({
              type:"POST",
              url:"<?php echo base_url('AN_ajax_author/hapus_group_menu') ?>",
              data:{"id":id},
              cache:false,
              success: function(a){
                if(a=="ok"){
           ...
           $(".buat-menu-btn").click(function(){
                if(!ajax_request){
                  ...
                  if(!/^[\w]{5,50}$/.test(code_menu)){
                    ...
                    $.ajax({
                      type:"POST",
                      url:"<?php echo base_url() ?>AN_ajax_author/cek_code_menu",
                      data: {"code":code_menu},
                      cache: false,
                      success: function(a){
                        if(a=="ok"){
                          ...
                          $.ajax({
                          type:"POST",
                          url:"<?php echo base_url() ?>AN_ajax_author/menu_baru",
                          data: {"code":code_menu,"nama":nama_menu},
                          cache: false,
                          success: function(a){
                            if(/^[\d]+$/.test(a)){
                          show_proses("Berhasil... mereload halaman")
                           window.location.assign("<?php echo base_url(); ?>author/menu/"+a);
                            } else {
                     ...
                     if(!_this[0].menyimpan){
                       ...
                       if(!/^[\s]+$/.test(nama=$(this).val()) && nama!=""){
                        ...
                        $.ajax({
                          ...
                          cache:false,
                          dataType: "json",
                          url:"<?php echo base_url('AN_ajax_author/new_kategori_galeri') ?>",
                          success:function(a){
                            _this.hide().val();
           ...
           $(document).on("keydown",".kategori-nama",function(evt){
              ...
              if(evt.keyCode== 13 ){    
                ...
                if(!_this[0].hai){
                 ...
                 $.ajax({
                  ...
                  url:"<?php echo base_url('AN_ajax_author/edit_kategori_galeri/nama') ?>",
                  cache:false,
                  success:function(a){
                    if(a=="ok"){
                     _this.hide();
            ...
            function hapus_kategori(_this){
              ...
              $.ajax({
                type:"POST",
                data:{"id":id},
                url:"<?php echo base_url('AN_ajax_author/edit_kategori_galeri/hapus') ?>",
                cache:false,
                success:function(a){
                  if(a=="ok"){
            ...
            $(document).on("click",".disable-kategori, .enable-kategori",function(){
             ...
             $.ajax({
              ...
              data:{"id":id},
              cache:false,
              url:"<?php echo base_url().'AN_ajax_author/edit_kategori_galeri/' ?>"+modul,
              success:function(a){
                if(a=="ok"){
           ...
           function aktif_toggle_kategori(_this){
              if(!_this[0].memproses){
                ...
                $.ajax({
                  ...
                  url:"<?php echo base_url('AN_ajax_author/aktif_kategori_produk'); ?>",
                  cache:false,
                  dataType:"json",
                  success:function(a){
                    $.each(a,function(i,v){
                     ...
                     if(!_this[0].menyimpan){
                       ...
                       if(!/^[\s]+$/.test(nama=_this.val()) && nama!=""){
                        ...
                        $.ajax({
                          ...
                          cache:false,
                          dataType: "json",
                          url:"<?php echo base_url('AN_ajax_author/new_kategori_produk') ?>",
                          success:function(a){
                            _this.hide().val();
                     ...
                     if(!_this[0].menyimpan){
                       ...
                       if(!/^[\s]+$/.test(nama=_this.val()) && nama!=""){  
                        $.ajax({
                          ...
                          cache:false,
                          dataType: "json",
                          url:"<?php echo base_url('AN_ajax_author/update_kategori_produk') ?>",
                          success:function(a){
                            _this.hide().val("");
           ...
           ?>
            ...
            $(".banner-baru").click(function(){
              ...
              if(!_this[0].menyimpan){
                ...
                $.ajax({
                  type:"POST",
                  data:data,
                  url: "<?php echo base_url('AN_ajax_author/new_banner_depan') ?>",
                  cache: false,
                  dataType: "json",
                  success:function(a){
                    $(".form-banner-baru").slideToggle();
                ...
                if(e.keyCode==13){
                  if(!target[0].menyimpan){
                    ...
                    $.ajax({
                      ...
                      data:data,
                      dataType:"json",
                      url:"<?php echo base_url('AN_ajax_author/update_banner_depan') ?>",
                      cache:false,
                      success:function(a){
                        target.val(a.val);
            ...
            function hapus_banner(_this){
              ...
              $.ajax({
                type:"post",
                data:{id:id},
                url:"<?php echo base_url('AN_ajax_author/delete_banner_depan')  ?>",
                dataType:"json",
                cache:false,
                success: function(a){
           ...
           $(".tambah-Artikel").click(function(){
            ...
            if(!_this[0].menambahkan){
              ...
              $.ajax({
                ...
                url:"<?php echo base_url('AN_ajax_author/news_ticker') ?>",
                cache:false,
                dataType: 'json',
                success:function(a){
       ...
       if(e.keyCode==13){
          ...
          var data={id:id,nilai:vall};
            ...
            $.ajax({
              type:"POST",
              data:data,
              url:"<?php echo base_url('AN_ajax_author/update_news_ticker'); ?>",
              cache:false,
              dataType: 'json',
              success: function(a){
  ...
  function hapus_news_ticker(_this){
    ...
    $.ajax({
      type:"post",
      data:{id:id},
      url:"<?php echo base_url('AN_ajax_author/delete_news_ticker'); ?>",
      cache:false,
      dataType: 'json',
      success : function(){
        ...
        _this[0].menghapus=false;
           ...
           ?>
              ...
              $(document).on("click",".lihat-pesan",function(){
                ...
                $.ajax({
                  ...
                  type:"POST",
                  data:{id:id},
                  url:"<?php echo base_url('AN_ajax_author/baca_inbox'); ?>",
                  cache:false,
                  dataType:"json",
                  success: function(a){
              ...
              function hapus_pesan(id){  
                ...
                $.ajax({
                  type:"POST",
                  data:{id:id},
                  url:"<?php echo base_url('AN_ajax_author/hapus_pesan'); ?>",
                  cache: false,
                  dataType:"json",
                  success: function(a){
              ...
              if(!_this[0].memproses){
                ...
                if(tema>0 && versi>=1 && gm!=""){
                  ...
                  $.ajax({
                    type:"POST",                    
                    data:formdata,
                    url:"<?php echo base_url('AN_ajax_author/distribusi_tema'); ?>",
                    dataType:"json",
                    cache:false,
                    processData: false,
                    contentType: false,
            ...
            $(".tombol-tema-baru").click(function(){
              ...
              if(/^[\w-]{4,100}$/.test(nama)){
                  ...
                  $.ajax({
                    type:"POST",
                    data:{nama:nama},
                    url:"<?php echo base_url('AN_ajax_author/tema_baru') ?>",
                    dataType: "json",
                    cache: false,
                    success: function(a){
                      if(a.status=="error"){
          ...
          $(".aktifkan-tema").click(function(){
            ...
            $.ajax({
              ...
              data:{id:id},
              dataType: "json",
              url: "<?php echo base_url('AN_ajax_author/aktifkan_tema') ?>",
              cache: false,
              success: function(a){
                if(a.status=="error"){
                  hide_proses()
    ...
    function hapus_tema(_this){ 
      ...
      $.ajax({
        ...
        data:{id:id},
        dataType: "json",
        url: "<?php  echo base_url('AN_ajax_author/hapus_tema') ?>",
        cache:false,
        success: function(a){
          if(a.status=="error"){
            error_alert("Error",a.pesan);
        ...
        if(!_this[0].mengupload){
          ...
          if(file){
            ...
            $.ajax({
              type:"post",
              data:data,
              url:"<?php echo base_url('AN_ajax_author/upload_tema_baru'); ?>",
              dataType: "json",
              cache: false,
              processData: false,
              contentType: false,
...
<!-------------------------------------------------------------------------------------------------->
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo $path_avatar; ?>" class="img-circle img-bordered-md user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url() ?>author/profil_user" class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url() ?>author/logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
  ...
  <!-------------------------------------------------------------------------------------------------->        <!-- Sidebar user panel (optional) -->
          <div class="user-panel">
            <div class="pull-left image">
              <img src="<?php echo $path_avatar; ?>" class="img-circle img-bordered-md" alt="User Image" />
            </div>
...
<!-------------------------------------------------------------------------------------------------->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header text-red"><b>MENU NAVIGASI</b></li>
            ...
            <li class='treeview  <?php if(($npage==6) OR( $npage==7)){ echo'active';} ?>'>
              ...
              <ul class='treeview-menu'>
                <li class='<?php if($npage==6){ echo'active';} ?>'><a href='<?php echo $burl; ?>/artikel'><i class="fa fa-circle-o text-red"></i><span>Tambahkan Artikel</span></a></li>
            ...
            <li class="treeview"><a href='<?php echo $burl; ?>'><i class="fa fa-cogs" aria-hidden="true"></i><span>PENGATURAN</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
            <li class='<?php if($npage==5){ echo'active';} ?>'><a href='<?php echo $burl; ?>/edit_profil'><i class="fa fa-circle-o text-red"></i><span>Edit Profil</span></a></li>
