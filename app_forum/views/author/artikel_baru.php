					...
					<div class="col-md-12 col-xs-12">
						...
						if($artikel_photos!=false){
							foreach ($artikel_photos as  $value) {
								...
								<button class='btn btn-danger btn-sm featured-tombol'>jadikan featured image</button>
						...
						<div class="form-group">
							 ...
							 <button class="btn btn-sm btn-danger save-artikel"><?php echo ($artikel_id==0 || $artikel_status=='draft')?'Publish':'Update' ?></button>
