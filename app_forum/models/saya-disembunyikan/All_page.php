	...
	function all_pages(){
		...
		if($query->num_rows()>0){
			...
			foreach($query->result_array() as $value){
				...
				$this->hasil.="<td><a href='".base_url()."saya-disembunyikan/page/$value[page_id]'><i class='fa fa-edit btn-edit-page'></i></a> &nbsp; <i style='cursor:pointer;color:red' class='fa fa-times-circle hapus-page' id='$value[page_id]'></i></td>";
				$this->hasil.="</tr>";
