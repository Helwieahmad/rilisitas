	...
	function get_all_menu(){
		...
		if($query->num_rows()>0){
			...
			foreach($query->result_array() AS $data){
				...
				$this->hasil.="<td><a href='".base_url()."saya-disembunyikan/menu/$data[menu_id]'><i class='fa fa-edit' style='cursor:pointer'></i></a> &nbsp; <i style='cursor:pointer;color:red' class='fa fa-times-circle hapus-menu' id='$data[menu_id]'></i> </td>";
				$this->hasil.="</tr>";
			}
