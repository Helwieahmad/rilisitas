...
class Tags_diskusi extends AN_Rilisitas
{
    ...
    function detail($id=0,$page=0){
		...
		$config['total_rows']=$this->diskusi->hitung_semua_diskusi_per_tag($id);
		...
		$data["informasi"]["current_page"]="diskusi-per-tag";
		...
		$data["semua_diskusi"]=$this->diskusi->diskusi_per_tag($id,$config['per_page'],$page);
