...
class AN_Rilisitas extends CI_Controller{
	...
	public function __construct(){
	 ...
	 $this->load->library("diskusi");
	 $this->load->library("riliser");

	 $this->artikel_populer=$this->artikel->artikel_populer($this->system_info['max_populer_artikel']);
	 $this->diskusi_populer=$this->diskusi->diskusi_populer($this->system_info['max_populer_artikel']);
	 ...
	 $this->public_data=array(
			...
			"diskusi_populer"=>$this->diskusi_populer,
	...
	protected function get_diskusi(){
	}
